...
{
    private void CreateLobbySupervisor(out TestProbe probe, out IActorRef lobbySupervisor)
    {
    ...
    {
        CreateLobbySupervisor(out TestProbe probe, out IActorRef lobbySupervisor);
